...
def decode_transaction(tx_data, idl):
    ...
    # ["params"][ "result"][ "value "][  "block" ][  "transactions" ]["transaction"]
    # Decode the base64 transaction data
    print(tx_data["params"]["result"]["value"]["block"]["transactions"][0]["version"])
    try:
        tx_data_decoded = base64.b64decode(tx_data["params"]["result"]["value"]["block"]["transactions"][0]["transaction"][0])
    except:
        print("first Error")
    ...
    if tx_data["params"]["result"]["value"]["block"]["transactions"][0]["version"] == 0:
...
tx_file_path = "raw0.json"



idl = load_idl("idl.json")
#print(tx_file_path)
