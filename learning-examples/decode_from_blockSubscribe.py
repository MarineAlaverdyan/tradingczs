...
if len(sys.argv) != 2:
    tx_file_path = r"C:\Users\User\PycharmProjects\colect_trader_tradHistori_and_analize_them\AA\pumpfun-bonkfun-bot-main\learning-examples\blockSubscribe-transactions\raw_create_tx_from_blockSubscribe.json"
    print(f"No path provided, using the path: {tx_file_path}")
else:
    tx_file_path = sys.argv[1]

idl = load_idl(r"C:\Users\User\PycharmProjects\colect_trader_tradHistori_and_analize_them\AA\pumpfun-bonkfun-bot-main\idl\pump_fun_idl.json")
